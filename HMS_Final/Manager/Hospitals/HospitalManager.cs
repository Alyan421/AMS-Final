...
namespace HMS_Final.Manager.Hospitals
{
    public class HospitalManager : IHospitalManager
    {
        ...
        public HospitalManager(IGenericRepository<Hospital> hospitalRepository, ILogger<HospitalManager> logger, IGenericRepository<HospitalDepartment> hospitalDepartmentRepository
        ...
        //public async Task<Hospital> CreateHospital(Hospital hospital, List<HospitalDepartmentDTO1>? departmentDTOs = null)
        //{
        //    try
        //    {
        ...
        //                    DepartmentId = departmentDTO.DepartmentId // Ensure this matches the DTO property
        //                };
    ...
    List<HospitalDoctorDTO2>? doctorDTOs = null)
        ...
        //        throw new Exception("An error occurred while deleting the hospital. Please try again.");
        //    }
        //}
